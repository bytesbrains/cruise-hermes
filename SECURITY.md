...
- A `cru_` project key in the environment or Hermes config — never in a committed config file.
...
None should exist. `.gitignore` excludes `.env` and key material. GitHub secret scanning and
push protection should stay enabled on the remote.
